...
<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="DmcapbacEdit.aspx.cs" Inherits="DmcapbacEdit" Title="Dmcapbac Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Dmcapbac - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="IdCapbac" runat="server" DataSourceID="DmcapbacDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/DmcapbacFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:DmcapbacDataSource ID="DmcapbacDataSource" runat="server"
			SelectMethod="GetByIdCapbac"
		>
			<Parameters>
				<asp:QueryStringParameter Name="IdCapbac" QueryStringField="IdCapbac" Type="String" />

			</Parameters>
		</data:DmcapbacDataSource>
		...
		<data:LscapbacDataSource ID="LscapbacDataSource" runat="server" SelectMethod="Find">
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:LscapbacFilter  Column="IdCapbac" QueryStringField="IdCapbac" /> 
					</Filters>
				</data:SqlParameter>
		...
		<data:QuannhanDataSource ID="QuannhanDataSource" runat="server" SelectMethod="Find">
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:QuannhanFilter  Column="IdCapbac" QueryStringField="IdCapbac" /> 
					</Filters>
				</data:SqlParameter>
				<data:CustomParameter Name="OrderByClause" Value="" ConvertEmptyStringToNull="false" /> 
		    </Parameters>
