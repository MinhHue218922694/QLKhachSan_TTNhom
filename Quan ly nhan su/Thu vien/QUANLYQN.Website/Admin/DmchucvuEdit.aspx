...
<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="DmchucvuEdit.aspx.cs" Inherits="DmchucvuEdit" Title="Dmchucvu Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Dmchucvu - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="IdChucvu" runat="server" DataSourceID="DmchucvuDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/DmchucvuFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:DmchucvuDataSource ID="DmchucvuDataSource" runat="server"
			SelectMethod="GetByIdChucvu"
		>
			<Parameters>
				<asp:QueryStringParameter Name="IdChucvu" QueryStringField="IdChucvu" Type="String" />
		...
		<data:LschucvuDataSource ID="LschucvuDataSource" runat="server" SelectMethod="Find">
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:LschucvuFilter  Column="IdChucvu" QueryStringField="IdChucvu" /> 
					</Filters>
				</data:SqlParameter>
		...
		<data:QuannhanDataSource ID="QuannhanDataSource" runat="server" SelectMethod="Find">
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:QuannhanFilter  Column="IdChucvu" QueryStringField="IdChucvu" /> 
					</Filters>
				</data:SqlParameter>
				<data:CustomParameter Name="OrderByClause" Value="" ConvertEmptyStringToNull="false" /> 
		    </Parameters>
