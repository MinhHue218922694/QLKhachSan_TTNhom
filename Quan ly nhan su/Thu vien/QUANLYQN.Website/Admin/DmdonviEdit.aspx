...
<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="DmdonviEdit.aspx.cs" Inherits="DmdonviEdit" Title="Dmdonvi Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Dmdonvi - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="IdDonvi" runat="server" DataSourceID="DmdonviDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/DmdonviFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:DmdonviDataSource ID="DmdonviDataSource" runat="server"
			SelectMethod="GetByIdDonvi"
		>
			<Parameters>
				<asp:QueryStringParameter Name="IdDonvi" QueryStringField="IdDonvi" Type="String" />
		...
		<data:QuannhanDataSource ID="QuannhanDataSource" runat="server" SelectMethod="Find">
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:QuannhanFilter  Column="IdDonvi" QueryStringField="IdDonvi" /> 
					</Filters>
				</data:SqlParameter>
