...
<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="DmlopEdit.aspx.cs" Inherits="DmlopEdit" Title="Dmlop Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Dmlop - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="IdLop" runat="server" DataSourceID="DmlopDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/DmlopFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:DmlopDataSource ID="DmlopDataSource" runat="server"
			SelectMethod="GetByIdLop"
		>
			<Parameters>
				<asp:QueryStringParameter Name="IdLop" QueryStringField="IdLop" Type="String" />
		...
		<data:QuannhanDataSource ID="QuannhanDataSource" runat="server" SelectMethod="Find">
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:QuannhanFilter  Column="IdLop" QueryStringField="IdLop" /> 
					</Filters>
				</data:SqlParameter>
