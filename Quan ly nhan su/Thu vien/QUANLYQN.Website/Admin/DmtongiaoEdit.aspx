...
<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="DmtongiaoEdit.aspx.cs" Inherits="DmtongiaoEdit" Title="Dmtongiao Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Dmtongiao - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="IdTongiao" runat="server" DataSourceID="DmtongiaoDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/DmtongiaoFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:DmtongiaoDataSource ID="DmtongiaoDataSource" runat="server"
			SelectMethod="GetByIdTongiao"
		>
			<Parameters>
				<asp:QueryStringParameter Name="IdTongiao" QueryStringField="IdTongiao" Type="String" />
		...
		<data:QuannhanDataSource ID="QuannhanDataSource" runat="server" SelectMethod="Find">
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:QuannhanFilter  Column="IdTongiao" QueryStringField="IdTongiao" /> 
					</Filters>
				</data:SqlParameter>
